    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg max-w-6xl w-full mx-4 max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredAndSortedViews.map((view) => (
                    ...
                    >
                      ...
                      <div className="h-32 bg-gray-100 relative">
                        ...
                        <div className="absolute top-2 right-2">
                          <button
                            ...
                            className="p-1 bg-white bg-opacity-90 rounded-full hover:bg-opacity-100 shadow-sm"
                          >
                      ...
                      {/* Content */}
                      <div className="p-4">
                        <h3 className="font-semibold text-gray-900 mb-1 truncate" title={view.name}>
                          {view.name}
                        </h3>
                        ...
                        <button
                          onClick={() => handleLoadView(view.id)}
                          className="w-full mt-3 px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 flex items-center justify-center gap-2"
                        >
                          <Eye size={16} />
        ...
        {showImport && (
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
              <h3 className="text-lg font-semibold mb-4">Importar Visualizações</h3>
